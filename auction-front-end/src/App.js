                    ...
                    <div className="app-container">
                        ...
                        <div className="content-container">
                            <Routes>
                                ...
                                <Route path="/auction-register" element={<PrivateRoute/>}>
                                    <Route path="" element={<RegisteredAuctionsHistory/>}/>
                                </Route>
                                <Route path="/bid-history" element={<PrivateRoute/>}>
                                    <Route path="" element={<BidHistory/>}/>
                                </Route>
